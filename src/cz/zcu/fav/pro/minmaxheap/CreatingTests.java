...
public class CreatingTests {
    ...
    public void creatingRandomValuesTest() throws Exception {
        ...
        OutputFormater.format("Test vytvoření haldy náhodných prvků o velikosti: %8d, s maximálním prvkem: %8d a s časem: %dms%n", size, max, delta);
    }
    ...
    public void creatingSameValuesTest() throws Exception {
        ...
        long delta = end - start;
        OutputFormater.format("Test vytvoření haldy stejných prvků o velikosti: %8d, s maximálním prvkem: %8d a s časem: %dms%n", size, value, delta);
